  ...
  return (
    <div className="offlineContract_container">
      ...
      <pre className="contractDetail">
        매수인과 작가 간의 작품 매매계약서 매수인 buyer_id (이하 ‘매수인’)과
        작가 owner_id(이하 ‘작가’)는 아래와 같이 미술작품의 매매계약을 체결한다.
        본계약에 명시된 buyer_id, owner_id, art_name, price는 클레이튼 네트워크
        등록된 본 트랜잭션의 buyer_id, owner_id, art_name, price를 말한다.
        제1조(목적) 본 계약은 매도인인 작가가 매수인에게 미술작품(이하 ‘작품
        혹은 art_name’)의 소유권을 이전하고 매수인이 작가에게 그 대금을 지급함에
        있어서 필요한 제반 사항과 당사자의 권리 및 의무를 규율함에 목적이 있다.
        제2조(매매 대상 작품) 작가(owner_id)는 클레이튼 네트워크에 등록된 본
        트랜잭션에 art_name으로 작품명이 명시된 작품 1점을 매수인(buyer_id)에게
        매도한다. (지금은 작품 명만 넣는걸로) 제3조(매매대금 및 지급 방법) ①
        매수인은 작가에게 작품 매매대금으로 금 (price)원을 원을 지급한다. 그
        구체적인 지급 금액과 일정은 다음과 같다. 1. 계약 체결과 동시에
        계약금으로 총액의 50% 지급 2. 작품 인도 시 잔금으로 총액의 50% 지급 ②
        작가는 매수인으로부터 매매대금의 잔금을 수령함과 동시에 작품을
        매수인에게 인도하여야 하며, 이로 인하여 소유권이 이전된다. 제4조(작품의
        인도) 작가는 협의된 일시까지 협의된 장소로 작품을 인도하여야 한다.
        작품의 인도와 관련한 운송료 및 보험료는 양 당사자가 협의하여 부담한다.
        제5조(작품의 관리) ① 작품이 제4조에서 정한 인도일 이전에 불가항력적인
        사유로 멸실, 파손, 도난되어 계약의 목적을 달성할 수 없게 된 경우 작가는
        계약금을 반환하여야 하며, 이 때 매수인은 별도로 손해배상을 청구할 수
        없다. 그러나 작가의 귀책사유로 작품이 멸실, 파손, 도난된 경우 작가는
        손해배상책임을 부담한다. ② 작가는 제4조에 따른 작품 인도와 함께 작품의
        설치, 전시, 유지, 관리 등에 관한 매뉴얼을 매수인에게 제공하여야 한다. ③
        작가는 작품 인도 후 작품이 자연적으로 마모되거나 변색, 변형, 훼손된 경우
        작품의 유지, 보수를 위하여 매수인에게 적극적으로 협조하여야 한다.
        제6조(확인 및 보증) ① 작가는 작품을 스스로 창작하였고 작품에 대한
        소유권을 적법하고 유효하게 보유하고 있어 이에 관한 어떠한 법률적 문제도
        없음을 보증한다. ② 작가는 작품의 인도 시 작품이 진품임을 확인하는 내용의
        진품 확인서 등 문서를 교부하여야 한다. 제7조(저작권) ① 작품에 대한
        소유권 이전에도 불구하고 작품의 저작권은 작가에게 귀속된다. ② 매수인은
        작품 원본의 소유자로서 그 저작물을 원본에 의하여 전시할 수 있다. 다만
        가로·공원·건축물의 외벽 그 밖에 공중에게 개방된 장소에 항시 전시하는
        경우에는 작가의 동의를 얻어야 한다. ③ 매수인은 전항에 따른 전시를 하는
        경우 미술계의 관례에 따라 작가의 의사에 반하지 않는 방법으로 작가의
        성명, 작품명, 작품의 재료 및 크기를 표시하여야 한다. ④ 매수인은 작품에
        대한 변조, 개작, 훼손 등 작가의 인격권을 해하는 방법으로 작품을
